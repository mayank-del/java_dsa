...
//how to access each bit while iterating from least significant bits in our code
int kth=5;
int num=100;

for(int i=0;i<=kth;i++){
	int bit=(num>>i) & 1;
	if(bit == 1) System.out.println("It means ith bit is 1");
	else(bit == 0) System.out.println("It means ith bit is 0");
}